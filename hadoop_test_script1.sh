...
--output  hdfs://sd-spark01.localdomain:9000/H5_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H10_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H15_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H20_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H25_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H30_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H35_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H40_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H45_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H50_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H55_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H60_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H65_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H70_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H75_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H80_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H85_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H90_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H95_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
...
--output  hdfs://sd-spark01.localdomain:9000/H100_000_000 --lambda 0.01 --numFeatures 50 --numIterations 15 \
